...
const megaPokemonNames = [
    ...
    "ampharos-mega", "scizor-mega", "heracross-mega", "tyranitar-mega",
    "blaziken-mega", "mawile-mega", "manectric-mega", "lucario-mega",
    "absol-mega", "garchomp-mega", "latias-mega", "latios-mega",
    "swampert-mega", "sceptile-mega", "sableye-mega", "altaria-mega",
    "metagross-mega", "salamence-mega", "lopunny-mega", "beedrill-mega",
    "pidgeot-mega", "slowbro-mega", "steelix-mega", "diancie-mega"
];
...
const MegaEvolutions = () => {
    ...
    useEffect(() => {
        const fetchMegas = async () => {
            const data = await Promise.all(
                megaPokemonNames.map(async (name) => {
    ...
    return (
        <div className="flex flex-col md:flex-row bg-[#1e103b] text-white rounded-lg overflow-hidden font-serif">
            {/* Left: List */}
            <div className="md:w-1/2 w-full bg-[#2b1a5a] p-6 scrollbar-hide overflow-y-auto max-h-[90vh]">
                <h1 className="text-4xl font-bold mb-6">Mega Evolutions</h1>
                    ...
                    {megas.map((p, index) => (
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <span className="capitalize font-bold">{p.name.replace("-mega", "").replace("-", " ")}</span>
                            </div>
                    ...
                    <>
                        ...
                        <div>
                            <h2 className="text-6xl tracking-widest font-bold uppercase">
                                {selectedPokemon.name.replace("-mega", "").replace("-", " ")}
                            </h2>
